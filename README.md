...
| 文件 | 作用 |
| --- | --- |
| `install.bat` / `install.ps1` | 安装入口与安装脚本 |
| `start.bat` | 启动入口 |
| `DSH-Launcher.ps1` | 启动器核心脚本（桌面快捷方式指向它） |
| `stop.bat` / `stop.ps1` | 停止服务器入口与脚本 |
| `uninstall.bat` / `uninstall.ps1` | 卸载入口与脚本 |
| `README.md` | 本说明文档 |
...
**Q：双击 install.bat 提示未检测到 Node.js？**
